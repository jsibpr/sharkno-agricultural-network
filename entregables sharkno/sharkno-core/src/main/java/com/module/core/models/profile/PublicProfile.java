...
public class PublicProfile extends BasicProfile {
	...
	public PublicProfile(String id, String name, AboutMe aboutMe, String profilePicture, LocalDate birthDate,
			String email, String phone, Address address, String web, List<Entity> skills, List<Segment> experience, List<Segment> studies, List<Review> reviews,
			List<Recommendation> recommendations, Type type, BigDecimal salary, Contact.Status status, Float averageReview, int likeQty) {
